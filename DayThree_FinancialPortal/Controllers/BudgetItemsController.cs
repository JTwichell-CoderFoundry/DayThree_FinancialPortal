...
namespace DayThree_FinancialPortal.Controllers
{
    public class BudgetItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,BudgetId,Name,Created,CurrentBalance,IsDeleted,Deleted")] BudgetItem budgetItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BudgetId,Name,Created,CurrentBalance,IsDeleted,Deleted")] BudgetItem budgetItem)
        {
            if (ModelState.IsValid)
            {
